    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag(Varyings i) : SV_Target
            {
                ...
                surfaceData.albedo = albedo.rgb * _BaseColor;
                surfaceData.specular = 0.6; 
                surfaceData.metallic = 0.05; 
                surfaceData.occlusion = 1; 
                surfaceData.smoothness = 0.6;
                InputData inputData = InitializeInputData(i, surfaceData.normalTS);

                
                float4 Surfacecolor = UniversalFragmentPBR(inputData, surfaceData);
                color.a = 1;
                return color;*/
                ...
                //if(NdotL==0)return float4(1,0,0,1);

                //return float4(ks.x, ks.y, ks.z, 1);                
